...
description: "Learn why Backend-for-Frontend (BFF) is the only auth architecture that survives npm supply chain attacks."
image: /img/blogs/bff/bff-security-architecture-header.png
authors: Kim Maida
...
To follow along, you need [Node.js](https://nodejs.org), npm, and [Docker](https://www.docker.com/) installed.
...
9. Edit the `.env` file and set the `CLIENT_ID` and `CLIENT_SECRET` variables to the following values:
