...
This guide will show two ways to extend the [Express](https://expressjs.com)-based [ChangeBank application](/docs/get-started/quickstarts/web/quickstart-javascript-express-web) to limit concurrent logins.
