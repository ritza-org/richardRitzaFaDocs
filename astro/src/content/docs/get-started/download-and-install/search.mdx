...
This page explains how to configure simple database search for FusionAuth, or install Elasticsearch or OpenSearch, which provides full-text search. Elasticsearch may be horizontally scaled using Elasticsearch clustering.

<Aside type="note">
FusionAuth supports Elasticsearch and OpenSearch with the same features. This guide uses the term "Elasticsearch" for both options. You can choose whichever you prefer.
</Aside>
