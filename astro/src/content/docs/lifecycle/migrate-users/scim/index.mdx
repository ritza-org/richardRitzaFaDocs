...
This overview summarizes the FusionAuth concepts relating to SCIM. For a complete practical guide to configuring and calling SCIM, follow the walkthrough [here](/docs/lifecycle/migrate-users/examples/manage-users-with-scim).
